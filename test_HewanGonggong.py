...
class Test_HewanGonggong:
    ...
    def test_gonggong_output(self):
        hewan = Hewan('hewan')
        assert hewan.gonggong() == 'Suara gonggongan hewan', "Output should be 'Suara gonggongan hewan'"

    @pytest.mark.regression
    def test_gonggong_no_side_effects(self):
        hewan = Hewan('hewan')
        hewan_copy = Hewan('hewan')
        hewan.gonggong()
        assert hewan == hewan_copy, "The function gonggong should not modify the object"

    @pytest.mark.regression
    def test_gonggong_multiple_invocations(self):
        hewan = Hewan('hewan')
        for _ in range(10):
            assert hewan.gonggong() == 'Suara gonggongan hewan', "Output should be 'Suara gonggongan hewan' on each invocation"
