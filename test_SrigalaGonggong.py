...
class Test_SrigalaGonggong:
    ...
    def test_gonggong_with_valid_name(self):
        ...
        # Assert
        assert result == "hooooowll", "The gonggong method did not return the expected result with a valid name"
    ...
    def test_gonggong_with_empty_string(self):
        ...
        # Assert
        assert result == "hooooowll", "The gonggong method did not return the expected result with an empty string"
