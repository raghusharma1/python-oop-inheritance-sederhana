...
class Test_TesDiserang:
    ...
    def test_diserang_greater_damage(self):
        ...
        python.diserang(70)
        # Assert
        assert python.dmg == 80 // 10

    @pytest.mark.regression
    def test_diserang_lower_damage(self):
        # Arrange
        cobra = tes('cobra', 'python', 50, 85, 100)
        # Act
        cobra.diserang(90)
        # Assert
        assert cobra.dmg == 50 // 85
    ...
    def test_diserang_positive_darah(self):
        ...
        python.diserang(70)
        # Assert
        assert python.darah - python.dmg >= 0

    @pytest.mark.regression
    def test_diserang_negative_darah(self):
        # Arrange
        cobra = tes('cobra', 'python', 50, 85, 10)
        # Act
        cobra.diserang(90)
        # Assert
        assert cobra.darah - cobra.dmg < 0
