...
class Test_TesSerang:
    ...
    def test_damage_calculation(self):
        ...
        # Assert
        assert python.dmg == expected_dmg, "Damage calculation is incorrect"
    ...
    def test_output_messages(self, capsys):
        ...
        python = tes('python', 'cobra', 80, 10, 100)
        cobra = tes('cobra', 'python', 85, 5, 100)
        expected_output = "python menyerang cobra\n8 damage yang di keluarkan\n"
        ...
        # Assert
        assert captured.out == expected_output, "Output messages are incorrect"

    @pytest.mark.performance
    def test_extreme_values(self):
        # Arrange
        python = tes('python', 'cobra', 999999999, 1, 100)
        cobra = tes('cobra', 'python', 1, 999999999, 100)

        # Act
        python.serang(cobra)

        # Assert
        assert python.dmg == 999999999, "Function doesn't handle extreme values correctly"
